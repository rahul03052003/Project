<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="booking.aspx.cs" Inherits="CodeRed.User.pages.forms.booking" %>
              ...
              <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <select class="form-control select2" style="width: 100%;">
                          <option selected="selected">jp nager</option>
                          <option>kavita bekary</option>
                          <option disabled="disabled">California (disabled)</option>
                          <option>last stop</option>
                          <option>police booth</option>
                          <option>Goblimara</option>
                          <option>Shani Matma Temple</option>
                      </select>
                  </div>
                  <!-- /.form-group -->
