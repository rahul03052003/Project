<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgot.aspx.cs" Inherits="CodeRed.forgot" %>
...
<div class="text-center">
     ...
     <input type="submit" value="Login"  runat="server" class="btn btn-common log-btn" onserverclick="Unnamed_ServerClick" onclick="return valid();"/>
</div>
</form>
</div>
</div>
