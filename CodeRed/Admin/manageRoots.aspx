<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manageRoots.aspx.cs" Inherits="CodeRed.Admin.manageRoots" %>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
                   ...
                   <div class="col-xs-3">
      <a href="createRoot.aspx" class="btn btn-block btn-success">Add Root</a>
                       </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
               ...
               <%--   <th>Email</th>--%>
                ...
                <tr>
                 ...
                 <%-- <td><%# Eval("Cemail") %></td>--%>
                  ...
                  <td><%# Eval("InsertedOn") %></td>
                  <%--<td><%# Eval("Cost") %></td>
                  <td><%# Eval("CropDetails") %></td>--%>
                 
              
                  <td>
                      <a href="#"  id="ViewClaim" class="btn btn-block btn-success btn-xs" onclick="View(<%# Eval("RootId") %>)"><i class="fas fa-trash"></i>View</a>
                      <button type="button" id="DeleteClaim" class="btn btn-block btn-danger btn-xs" onclick="ClaimDelete(<%# Eval("RootId") %>)"><i class="fas fa-trash"></i>Delete</button></td>
                </tr>
