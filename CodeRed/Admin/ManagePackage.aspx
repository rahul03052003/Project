<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagePackage.aspx.cs" Inherits="CodeRed.Admin.ManagePackage" %>
  ...
  <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li><a href="ManageBooking.aspx"><i class="fa fa-circle-o text-yellow"></i> <span>Manage Booking</span></a></li>
            <li><a href="ManagePackage.aspx"><i class="fa fa-circle-o text-yellow"></i> <span>Manage Package</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Package table</li>
      </ol>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
              <h3 class="box-title">Trip Package Data</h3>
            <div class="box-header">
              
                   <div class="col-xs-3">
    <%--  <a href="createPackage.aspx" class="btn btn-block btn-success">Add Package</a>
      --%>                 </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
               ...
               <%--   <th>Action</th>--%>
                ...
                <tr>
                 ...
                 <%-- <td><%# Eval("Cemail") %></td>--%>
                  ...
                  <td>
                    <%--  <a href="#"  id="ViewClaim" class="btn btn-block btn-success btn-xs" onclick="View(<%# Eval("PackageId") %>)"><i class="fas fa-trash"></i>View</a>
                      <button type="button" id="DeleteClaim" class="btn btn-block btn-danger btn-xs" onclick="ClaimDelete(<%# Eval("PackageId") %>)"><i class="fas fa-trash"></i>Delete</button></td>
            --%>    </tr>
   ...
   <%-- <script>
               ...
               function ClaimDelete(id) {
                       ...
                       $.ajax({
                           ...
                           url: "managePackages.aspx/deleteClaim",
        ...
        <script>
            function View(id) {
                ...
                /* alert(id);*/
                window.location = "Edit.aspx?id=" + id;
            }--%>
