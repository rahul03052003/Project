<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageAgency.aspx.cs" Inherits="CodeRed.Admin.ManageAgency" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <td>
          ...
          <button type="button" id="RejectClaim" class="btn btn-block btn-danger btn-xs" onclick="Reject(<%# Eval("id") %>)"><i class="fas fa-trash"></i>Delete</button>
                  </td>
                </tr>
          ...
          <script>
              ...
              function Reject(id) {
                  ...
                  $.ajax({
                      ...
                      dataType: "json",
                      data: JSON.stringify({ ID: id }),
                      url: "ManageAgency.aspx/RejectClaim",
                      success: function (data) {
                          if (data.d == 1) {

                              alert("Agency Data Deleted.");
                              //toastr.success("Image Requested.");
                              window.location.reload();
