<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createFAQ.aspx.cs" Inherits="CodeRed.Admin.createFAQ" %>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="Pname" runat="server" placeholder="FAQ Title">
              </div>
            </div>
              <!-- /.form-group -->
              ...
              <input type="text" class="form-control" id="Ploc" runat="server" placeholder=" FAQ Answer">
              </div>
             </div>
