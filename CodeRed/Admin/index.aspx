<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="CodeRed.Admin.index" %>
...
<div class="wrapper">
      ...
      <div class="row">
        ...
        <!-- ./col -->
          ...
          <div class="small-box bg-red">
            ...
            <a href="ManagePackage.aspx" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
         ...
         <%-- <div class="small-box bg-red">
            <div class="inner">
              <h3><string id="counter"></string></h3>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023-2024 <a target="_blank" href="#">Travel management</a>.</strong> All rights
    reserved.
  </footer>
