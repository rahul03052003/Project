<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manageenquires.aspx.cs" Inherits="CodeRed.Agency.manageenquires" %>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
           ...
           <td><button type="button" id="ApproveClaim" class="btn btn-block btn-success" onclick="Approve(<%# Eval("ID") %>)"><i class="fas fa-trash"></i>Approve</button>
            
          <button type="button" id="RejectClaim" class="btn btn-block btn-danger btn-xs" onclick="Reject(<%# Eval("ID") %>)"><i class="fas fa-trash"></i>Reject</button>
                  </td>
                </tr>
    ...
    <script>
        ...
        function Approve(id) {
                       ...
                       $.ajax({
                           ...
                           url: "manageenquires.aspx/ApproveClaim",
        ...
        <script>
            ...
            function Reject(id) {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    data: JSON.stringify({ ID: id }),
                    url: "manageenquires.aspx/RejectClaim",
                    success: function (data) {
                        if (data.d == 1) {
