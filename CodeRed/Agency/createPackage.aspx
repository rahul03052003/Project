<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createPackage.aspx.cs" Inherits="CodeRed.Agency.createPackage" %>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="Pname" runat="server" placeholder="Create Package">
              </div>
            </div>
              <!-- /.form-group -->
             <div class="col-md-6">
           ...
           <%--   <input type="text" class="form-control"  runat="server" placeholder="Package Type eg- Family Package / Couple Package">--%>
              ...
              <input type="text" class="form-control" id="Ploc" runat="server" placeholder=" Package Location">
              </div>
             </div>
              <div class="col-md-6">
                <div class="form-group">
                <label>Package Price in RS</label>
              <input type="text" class="form-control" id="Pprice" runat="server" placeholder="Package Price is Rs">
              </div>
             </div>
              ...
              <input type="text" class="form-control" id="PFeatures" runat="server" placeholder="Package Features Eg-free Pickup-drop facility">
              </div>
             </div>   <div class="col-md-6">
                <div class="form-group">
                <label>Package Details</label>
              <input type="text" class="form-control" id="PDetails" runat="server" placeholder="Package Details">
              </div>
              ...
              <input type="time" class="form-control" id="ptime" runat="server" placeholder="Package Details">
              </div>
