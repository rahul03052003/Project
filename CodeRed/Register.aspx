<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="CodeRed.Register" %>
...
<input type="text" id="email" onchange="checkemail1()" runat="server" class="form-control" name="email" placeholder="Email Address">
     <asp:Label ID="lblmsg" runat="server" CssClass="errmsg" ForeColor="Red"></asp:Label>
...
<input type="date" id="dob" runat="server" class="form-control" name="dob" >
</div>
</div>
<div class="form-group">
<div class="input-icon">
...
<div class="text-center">
      ...
      <input type="submit"  runat="server" class="btn btn-common log-btn" onserverclick="Unnamed_ServerClick" onclick="return valid();"/>
</div>
</form>
</div>
</div>
