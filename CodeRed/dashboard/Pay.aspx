<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pay.aspx.cs" Inherits="CodeRed.dashboard.Pay" %>
                        ...
                        <div class="collapse p-3 pt-0" id="collapseExample">
                            <div class="row">
                                <div class="col-8">
                                    ...
                                    <p class="mb-0"><span class="fw-bold">Package:</span><span class="c-green">: </span></p>
                        ...
                        <div class="collapse show p-3 pt-0" id="collapseExample">
                            <div class="row">
                                <div class="col-lg-5 mb-lg-0 mb-3">
                                    <p class="h4 mb-0">Summary</p>
                                    <p class="mb-0"><span class="fw-bold">Product:</span><span class="c-green">: <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></span>
                                    </p>
                                    <p class="mb-0">
                                        <span class="fw-bold">Price:</span>
                                        <span class="c-green">:₹<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></span>
                                    </p>
                                ...
                                <div class="col-lg-7">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form__div">
                                                    <input type="text" class="form-control" placeholder=" " runat="server" id="fname" required="required">
                                            ...
                                            <div class="col-12">
                                                <div class="form__div">
                                                    <input type="text" class="form-control" placeholder=" " id="nameoncard" runat="server" required="required">
                                                    <label for="" class="form__label">name on the card</label>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                
                                                <input type="submit" class="btn btn-primary w-100" value="Submit" id="sub" runat="server" onserverclick="Unnamed_ServerClick"/>
                                            </div>
                                        </div>
